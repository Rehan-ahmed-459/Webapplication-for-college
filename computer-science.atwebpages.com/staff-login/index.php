...
$error2 ='';
 ...
 if(isset($_POST['submit'])){
    ...
    if ($num == 1){
		 $pass = mysqli_query($conn,"select password from staffs where username='$username'");
		 ...
		 if($password!==$dpass){
			...
			$error1="<div class='error'>Wrong password</div>";
  ...
  .error{
	...
	<div class="limiter">
		...
		<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="/my web/staff_login/index.php" enctype="multipart/form-data">
